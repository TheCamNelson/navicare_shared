...
import type { PatientCreateInput } from "./types.js";

export const seedPatients: PatientCreateInput[] = [
  {
    first_name: "Alice",
    last_name: "Anderson",
...
export async function seedDeterministicPatients(store: DataStore): Promise<void> {
